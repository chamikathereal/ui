      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between gap-2">
            <span
              ...
              className={!Boolean(currentItem.tag) ? "hidden" : "px-3 py-1 rounded-full bg-[#f5ebe1] text-[#84431b] text-[11px] uppercase tracking-wider font-extrabold border border-[#3d2114]/10"}
            >
              {tagText}
            </span>
    ...
    >
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12 sm:mb-16">
          <div className={!badge ? "hidden" : "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#ede0d4] text-[#3d2114] text-xs uppercase tracking-widest font-black border border-[#3d2114]/15"}>
